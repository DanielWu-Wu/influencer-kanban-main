...
> **文档定位**：这是后续 Codex 对话和开发人员的当前交接入口。本文基于 2026-07-13 的实际代码、`git log`、`git status` 与项目配置整理。旧的 `PROJECT_HANDOFF.md`、`README.md`、`TODO.md` 和 `docs/AI_HANDOFF.md` 可作为历史补充，但可能滞后或存在编码显示问题；后续应优先以本文件和实际代码为准。
